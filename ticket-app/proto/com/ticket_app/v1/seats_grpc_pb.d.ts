...
interface ISeatsService_IGetSeats extends grpc.MethodDefinition<com_ticket_app_v1_seats_pb.SeatsRequest, com_ticket_app_v1_seats_pb.SeatResponse> {
    path: "/com.ticket_app.v1.Seats/GetSeats";
    requestStream: false;
    responseStream: true;
    requestSerialize: grpc.serialize<com_ticket_app_v1_seats_pb.SeatsRequest>;
    requestDeserialize: grpc.deserialize<com_ticket_app_v1_seats_pb.SeatsRequest>;
    responseSerialize: grpc.serialize<com_ticket_app_v1_seats_pb.SeatResponse>;
    responseDeserialize: grpc.deserialize<com_ticket_app_v1_seats_pb.SeatResponse>;
}
...
export interface ISeatsServer extends grpc.UntypedServiceImplementation {
    ...
    getSeats: grpc.handleServerStreamingCall<com_ticket_app_v1_seats_pb.SeatsRequest, com_ticket_app_v1_seats_pb.SeatResponse>;
...
export interface ISeatsClient {
    ...
    getSeats(request: com_ticket_app_v1_seats_pb.SeatsRequest, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<com_ticket_app_v1_seats_pb.SeatResponse>;
    getSeats(request: com_ticket_app_v1_seats_pb.SeatsRequest, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<com_ticket_app_v1_seats_pb.SeatResponse>;
...
export class SeatsClient extends grpc.Client implements ISeatsClient {
    ...
    public getSeats(request: com_ticket_app_v1_seats_pb.SeatsRequest, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<com_ticket_app_v1_seats_pb.SeatResponse>;
    public getSeats(request: com_ticket_app_v1_seats_pb.SeatsRequest, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<com_ticket_app_v1_seats_pb.SeatResponse>;
