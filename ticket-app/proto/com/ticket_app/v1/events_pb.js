...
goog.exportSymbol('proto.com.ticket_app.v1.GetEventResponse', null, global);
goog.exportSymbol('proto.com.ticket_app.v1.GetEventsResponse', null, global);
 ...
 * @constructor
 */
proto.com.ticket_app.v1.GetEventResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.com.ticket_app.v1.GetEventResponse.repeatedFields_, null);
};
goog.inherits(proto.com.ticket_app.v1.GetEventResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.com.ticket_app.v1.GetEventResponse.displayName = 'proto.com.ticket_app.v1.GetEventResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.com.ticket_app.v1.GetEventsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.ticket_app.v1.GetEventsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.com.ticket_app.v1.GetEventsResponse.displayName = 'proto.com.ticket_app.v1.GetEventsResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.com.ticket_app.v1.GetEventResponse.repeatedFields_ = [5];
 ...
 * @return {!Object}
 */
proto.com.ticket_app.v1.GetEventResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.com.ticket_app.v1.GetEventResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.com.ticket_app.v1.GetEventResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.ticket_app.v1.GetEventResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    title: jspb.Message.getFieldWithDefault(msg, 2, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.ticket_app.v1.GetEventResponse}
 */
proto.com.ticket_app.v1.GetEventResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.ticket_app.v1.GetEventResponse;
  return proto.com.ticket_app.v1.GetEventResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.ticket_app.v1.GetEventResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.ticket_app.v1.GetEventResponse}
 */
proto.com.ticket_app.v1.GetEventResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.com.ticket_app.v1.GetEventResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.ticket_app.v1.GetEventResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.com.ticket_app.v1.GetEventResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.ticket_app.v1.GetEventResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.com.ticket_app.v1.GetEventResponse.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.com.ticket_app.v1.GetEventResponse} returns this
 */
proto.com.ticket_app.v1.GetEventResponse.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.com.ticket_app.v1.GetEventResponse.prototype.getTitle = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.com.ticket_app.v1.GetEventResponse} returns this
 */
proto.com.ticket_app.v1.GetEventResponse.prototype.setTitle = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 */
proto.com.ticket_app.v1.GetEventResponse.prototype.getSeatsList = function() {
 ...
 * @return {!proto.com.ticket_app.v1.GetEventResponse} returns this
*/
proto.com.ticket_app.v1.GetEventResponse.prototype.setSeatsList = function(value) {
 ...
 * @return {!proto.com.ticket_app.v1.EventSeat}
 */
proto.com.ticket_app.v1.GetEventResponse.prototype.addSeats = function(opt_value, opt_index) {
 ...
 * @return {!proto.com.ticket_app.v1.GetEventResponse} returns this
 */
proto.com.ticket_app.v1.GetEventResponse.prototype.clearSeatsList = function() {
 ...
 * @return {!Object}
 */
proto.com.ticket_app.v1.GetEventsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.com.ticket_app.v1.GetEventsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.com.ticket_app.v1.GetEventsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.ticket_app.v1.GetEventsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    title: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.ticket_app.v1.GetEventsResponse}
 */
proto.com.ticket_app.v1.GetEventsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.ticket_app.v1.GetEventsResponse;
  return proto.com.ticket_app.v1.GetEventsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.ticket_app.v1.GetEventsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.ticket_app.v1.GetEventsResponse}
 */
proto.com.ticket_app.v1.GetEventsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.com.ticket_app.v1.GetEventsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.ticket_app.v1.GetEventsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.com.ticket_app.v1.GetEventsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.ticket_app.v1.GetEventsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.com.ticket_app.v1.GetEventsResponse.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.com.ticket_app.v1.GetEventsResponse} returns this
 */
proto.com.ticket_app.v1.GetEventsResponse.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.com.ticket_app.v1.GetEventsResponse.prototype.getTitle = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.com.ticket_app.v1.GetEventsResponse} returns this
 */
proto.com.ticket_app.v1.GetEventsResponse.prototype.setTitle = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
